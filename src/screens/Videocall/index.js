...
import Videooff_Icon from '../../assets/Images/SVG/Videooff_Icon'
import CammeraCall from '../../assets/Images/Temp/CameraCall.png'
...
const Videocall = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity style={styles.phonefillview}>
                <PhoneFill />
            </TouchableOpacity>
